...
---
This document compares the results of the the DWBA implementation in ZooScat to an anlytical scattering model of a sphere [@anderson_sound_1950], following routines described in Jech et al. [-@jech_comparisons_2015].
